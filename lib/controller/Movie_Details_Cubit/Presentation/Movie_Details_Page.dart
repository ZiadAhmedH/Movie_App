            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                                  ...
                                  children: [
                                   ...
                                   RichText(text: TextSpan(
                                     children: [
                                       ...
                                       // add release date
                                        TextSpan(
                                          text: '  (${state.movieDetails.releaseDate?.substring(0, 4)})',
                                          style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 18,
                                            fontWeight: FontWeight.bold,
                  ...
                  // add movie overview
                  SizedBox(
                    child: state.movieDetails.overview != null
                        ? Padding(
                      padding: const EdgeInsets.all(16.0),
                      child: Column(
                  ...
                  Row(
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => YouTubeVideoPlayer(videoName: "${state.movieDetails.title}")));
                        },
